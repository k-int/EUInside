    ...
    <nav class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${createLink(uri: '/')}">KI Persistence</a>

          <div class="nav-collapse">
            <ul class="nav">
              <li<%= request.forwardURI == "${createLink(uri: '/')}" ? ' class="active"' : '' %>><a href="${createLink(uri: '/')}">Home</a></li>
              <li<%= request.forwardURI == "${createLink(uri: '/identify')}" ? ' class="active"' : '' %>><a href="${createLink(uri: '/identify')}">Identify</a></li>
              <li<%= request.forwardURI == "${createLink(uri: '/persistence')}" ? ' class="active"' : '' %>><a href="${createLink(uri: '/persistence')}">Persistence</a></li>
            </ul>
          </div>
